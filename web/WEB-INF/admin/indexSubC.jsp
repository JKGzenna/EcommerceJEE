<%-- 
    Document   : index admin registro de subcategorías
...
<!--                        <div class="col-sm-10 clearfix">-->
                                ...
                                <%=(request.getAttribute("mensajesubcat")!=null?request.getAttribute("mensajesubcat"):"")%>
                                <form action="RegistroDeSubCategoriaController" method="post" class="form-horizontal">
                                <br>
                                <br>
                                    <div class="form-group">
                                        ...
                                        <select name="categoriasuperior">
                                            <option>Seleccione una categoría superior</option>
