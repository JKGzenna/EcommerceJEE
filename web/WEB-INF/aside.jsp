<%-- 
    Document   : aside publico que enlaza a los controladores y muestra productos y marcas, asi como productos recomendados por defecto, lugar donde inicia
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
                                                                    <c:forEach var="m" items="<%= MarcaDao.listarTodoDeMarcas() %>">
                                                                        ...
                                                                        <li><a href="?brand=${m.codigo}"> <span class="pull-right">(<%= MarcaDao.contarMarcas(cod) %>)</span>${m.nombre}</a></li>
                                                                    </c:forEach>
								</ul>
							</div>
						</div><!--/brands_products-->
